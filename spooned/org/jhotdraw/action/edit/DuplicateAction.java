 ...
 * @version $Id$
 */
public class DuplicateAction extends org.jhotdraw.action.edit.AbstractSelectionAction {
     ...
     */
    public DuplicateAction(javax.swing.JComponent target) {
        super(target);
        org.jhotdraw.util.ResourceBundleUtil labels = org.jhotdraw.util.ResourceBundleUtil.getBundle("org.jhotdraw.action.Labels");
        labels.configureAction(this, org.jhotdraw.action.edit.DuplicateAction.ID);
    }
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if ((c != null) && c.isEnabled()) {
            if (c instanceof org.jhotdraw.api.gui.EditableComponent) {
                ((org.jhotdraw.api.gui.EditableComponent) (c)).duplicate();
            } else {
                c.getToolkit().beep();
            }
        }
