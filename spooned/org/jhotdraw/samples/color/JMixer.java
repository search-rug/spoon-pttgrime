/**
 *
 * @(#)JMixer.java <p>Copyright (c) 2008 The authors and contributors of JHotDraw. You may not use, copy or modify
...
public class JMixer extends javax.swing.JPanel {
    ...
    private org.jhotdraw.color.DefaultColorSliderModel sliderModel;
    ...
    private class Preset {
        ...
        public Preset(java.lang.String name, int index) {
            this.name = name;
            this.index = index;
        }

        public java.awt.Color getColor() {
            return new java.awt.Color(sliderModel.getColorSpace(), new float[]{ (index / 8) / 12.0F, 1.0F, ((index % 8) + 2) / 12.0F }, 1.0F);
        }
    ...
    public JMixer() {
        initComponents();
        javax.swing.DefaultComboBoxModel presets = new javax.swing.DefaultComboBoxModel();
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Powerful", 4));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Rich", 1));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Romantic", 7));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Vital", 12));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Earthy", 10));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Friendly", 20));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Soft", 22));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Welcoming", 28));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Moving", 36));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Elegant", 39));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Fresh", 52));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Traditional", 49));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Refreshing", 60));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Tropical", 62));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Classic", 68));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Dependable", 65));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Calm", 70));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Regal", 76));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Magical", 84));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Energetic", 92));
        presets.addElement(new org.jhotdraw.samples.color.JMixer.Preset("Subdued", 94));
        presetCombo.setModel(presets);
        java.awt.Font smallFont = new java.awt.Font("Lucida Grande", java.awt.Font.PLAIN, 11);
        for (java.awt.Component c : mixerPanel.getComponents()) {
            c.setFont(smallFont);
        }
        // Create a list, overriding the getToolTipText() method
        swatchesList = new javax.swing.JList() {
            private static final long serialVersionUID = 1L;
            ...
            public java.lang.String getToolTipText(java.awt.event.MouseEvent evt) {
                ...
                // Get item
                java.lang.Object item = getModel().getElementAt(index);
                javax.swing.JComponent c = ((javax.swing.JComponent) (getCellRenderer().getListCellRendererComponent(this, item, index, false, false)));
        ...
        harmonicWheel.setColorSpace(org.jhotdraw.color.HSLColorSpace.getInstance());
        scrollPane.setPreferredSize(new java.awt.Dimension(100, 100));
        swatchesList.setModel(((javax.swing.ListModel) (harmonicWheel.getHarmonicColorModel())));
        swatchesList.setCellRenderer(new org.jhotdraw.color.ColorListCellRenderer());
        sliderModel = new org.jhotdraw.color.DefaultColorSliderModel(harmonicWheel.getHarmonicColorModel().getColorSpace());
        sliderModel.configureSlider(1, saturationSlider);
        harmonicWheel.getHarmonicColorModel().addListDataListener(new javax.swing.event.ListDataListener() {
            @java.lang.Override
            ...
            public void contentsChanged(javax.swing.event.ListDataEvent e) {
                adjusting++;
                org.jhotdraw.color.HarmonicColorModel hcm = harmonicWheel.getHarmonicColorModel();
                java.awt.Color cc = hcm.get(e.getIndex0());
                if (cc != null) {
        ...
        harmonicWheel.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            @java.lang.Override
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                java.lang.String name = evt.getPropertyName();
                if (name == org.jhotdraw.color.JHarmonicColorWheel.SELECTED_INDEX_PROPERTY) {
                    adjusting++;
            ...
            public void stateChanged(javax.swing.event.ChangeEvent e) {
                if ((adjusting++) == 0) {
                    ...
                    if (!hcm.isAdjusting()) {
                        int index = harmonicWheel.getSelectedIndex();
                        if (index != (-1)) {
                            java.awt.Color cc = sliderModel.getColor();
                            java.awt.Color oldValue = hcm.get(index);
                            java.awt.Color newValue = new java.awt.Color(oldValue.getColorSpace(), org.jhotdraw.color.ColorUtil.fromColor(oldValue.getColorSpace(), cc), 1.0F);
        ...
        // updateRules();
        org.jhotdraw.color.HarmonicColorModel h = harmonicWheel.getHarmonicColorModel();
        java.awt.color.ColorSpace sys = h.getColorSpace();
        h.set(0, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 0, 19, 148), 1.0F));
        h.set(1, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 218, 37, 26), 1.0F));
        h.set(2, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 70, 148, 27), 1.0F));
        h.set(3, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 174, 46, 248), 1.0F));
        h.set(4, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 255, 252, 76), 1.0F));
        h.set(5, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 234, 155, 65), 1.0F));
        h.set(6, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 51, 51, 51), 1.0F));
        h.set(7, new java.awt.Color(sys, org.jhotdraw.color.ColorUtil.fromRGB(sys, 153, 153, 153), 1.0F));
    }
    ...
    public static void main(java.lang.String[] args) {
        javax.swing.SwingUtilities.invokeLater(new java.lang.Runnable() {
            @java.lang.Override
            public void run() {
                javax.swing.JFrame f = new javax.swing.JFrame("Mixer");
                f.add(new org.jhotdraw.samples.color.JMixer());
    ...
    private void updateRules() {
        org.jhotdraw.color.HarmonicColorModel m = harmonicWheel.getHarmonicColorModel();
        m.removeAllRules();
        ...
        if (customHueRadio.isSelected()) {
            ...
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 30.0F / 360.0F, 0, 5));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, (-30.0F) / 360.0F, 0, 10));
        } else if (primaryRadio.isSelected()) {
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 120.0F / 360.0F, 0, 5));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, (-120.0F) / 360.0F, 0, 10));
        } else if (clashRadio.isSelected()) {
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 90.0F / 360.0F, 0, 5));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, (-90.0F) / 360.0F, 0, 10));
        } else if (triadRadio.isSelected()) {
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 120.0F / 360.0F, 0, 5));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, (-120.0F) / 360.0F, 0, 10));
        } else if (splitComplementaryRadio.isSelected()) {
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 150.0F / 360.0F, 0, 5));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, (-150.0F) / 360.0F, 0, 10));
        } else if (complementaryRadio.isSelected()) {
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(0, 180.0F / 360.0F, 0, 5));
        }
        ...
        if (monochromaticCheck.isSelected()) {
             ...
             */
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, 1.0F / 12.0F, 0, 1, 2));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, 1.0F / 12.0F, 5, 6, 7));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, 1.0F / 12.0F, 10, 11, 12));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, (-1.0F) / 12.0F, 0, 3, 4));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, (-1.0F) / 12.0F, 5, 8, 9));
            m.addRule(new org.jhotdraw.color.SimpleHarmonicRule(2, (-1.0F) / 12.0F, 10, 13, 14));
        }
        m.applyRules();
    }
    ...
    private void systemChangePerformed(java.awt.event.ActionEvent evt) {
        ...
        if (sysRGBToggle.isSelected()) {
            sys = org.jhotdraw.color.HSLColorSpace.getInstance();
        } else {
            sys = org.jhotdraw.color.HSLPhysiologicColorSpace.getInstance();
        }
        m.setColorSpace(sys);
    ...
    private void presetPerformed(java.awt.event.ActionEvent evt) {
        ...
        java.lang.Object obj = presetCombo.getSelectedItem();
        if (obj instanceof org.jhotdraw.samples.color.JMixer.Preset) {
            org.jhotdraw.samples.color.JMixer.Preset preset = ((org.jhotdraw.samples.color.JMixer.Preset) (obj));
            org.jhotdraw.color.HarmonicColorModel m = harmonicWheel.getHarmonicColorModel();
