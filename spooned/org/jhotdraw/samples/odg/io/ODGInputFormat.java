 ...
 */
public class ODGInputFormat implements org.jhotdraw.draw.io.InputFormat {
    /**
    ...
    private org.jhotdraw.samples.odg.io.ODGStylesReader styles;
    ...
    public javax.swing.filechooser.FileFilter getFileFilter() {
        return new javax.swing.filechooser.FileNameExtensionFilter("Open Document Drawing (ODG)", "odg");
    }
    ...
    public void read(java.awt.datatransfer.Transferable t, org.jhotdraw.draw.Drawing drawing, boolean replace) throws java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException {
        java.io.InputStream in = ((java.io.InputStream) (t.getTransferData(new java.awt.datatransfer.DataFlavor("application/vnd.oasis.opendocument.graphics", "Image SVG"))));
        try {
    ...
    public void read(java.io.InputStream in, org.jhotdraw.draw.Drawing drawing, boolean replace) throws java.io.IOException {
        ...
        java.io.InputStream contentIn = null;
        // Input stream of the styles.xml file
        java.io.InputStream stylesIn = null;
        // Try to read "tmp" as a ZIP-File.
        boolean isZipped = true;
        try {
            java.util.zip.ZipInputStream zin = new java.util.zip.ZipInputStream(new java.io.ByteArrayInputStream(tmp));
            for (java.util.zip.ZipEntry entry; null != (entry = zin.getNextEntry());) {
                if ("content.xml".equals(entry.getName())) {
                    contentIn = new java.io.ByteArrayInputStream(readAllBytes(zin));
                } else if ("styles.xml".equals(entry.getName())) {
                    stylesIn = new java.io.ByteArrayInputStream(readAllBytes(zin));
                }
            }
        ...
        if (contentIn == null) {
            contentIn = new java.io.ByteArrayInputStream(tmp);
        }
        if (stylesIn == null) {
            stylesIn = new java.io.ByteArrayInputStream(tmp);
        }
        styles = new org.jhotdraw.samples.odg.io.ODGStylesReader();
    ...
    public void readFiguresFromDocumentContent(java.io.InputStream in, org.jhotdraw.draw.Drawing drawing, boolean replace) throws java.io.IOException {
        ...
        org.w3c.dom.Element drawingElem = document.getDocumentElement();
        java.util.Stack<org.w3c.dom.Node> stack = new java.util.Stack<org.w3c.dom.Node>();
        ...
        while ((!stack.empty()) && (stack.peek().getNextSibling() != null)) {
            org.w3c.dom.Node iter = stack.peek();
            org.w3c.dom.Node node = iter.getNextSibling();
            if (node.getNextSibling() == null) {
                stack.pop();
            } else {
                stack.set(stack.indexOf(iter), node);
            }
            org.w3c.dom.Node children = node.getFirstChild();
            if (children.getNextSibling() != null) {
                stack.push(children);
            }
            if (((node.getLocalName() != null) && node.getLocalName().equals("drawing")) && ((node.getPrefix() == null) || node.getPrefix().equals(org.jhotdraw.samples.odg.ODGConstants.OFFICE_NAMESPACE))) {
                drawingElem = ((org.w3c.dom.Element) (node));
                break;
            }
        } 
        if (((drawingElem.getLocalName() == null) || (!drawingElem.getLocalName().equals("drawing"))) || ((drawingElem.getPrefix() != null) && (!drawingElem.getPrefix().equals(org.jhotdraw.samples.odg.ODGConstants.OFFICE_NAMESPACE)))) {
            throw new java.io.IOException("'office:drawing' element expected: " + drawingElem.getLocalName());
        }
     ...
     */
    private void readDrawingElement(org.w3c.dom.Element elem) throws java.io.IOException {
        ...
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if ((child.getPrefix() == null) || child.getPrefix().equals(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE)) {
     ...
     */
    private void readPageElement(org.w3c.dom.Element elem) throws java.io.IOException {
        /* 9.1.4Drawing Pages
        ...
        for (int i = 0; i < list.getLength(); i++) {
            org.w3c.dom.Element child = ((org.w3c.dom.Element) (list.item(i)));
            org.jhotdraw.samples.odg.figures.ODGFigure figure = readElement(child);
            if (figure != null) {
                figures.add(figure);
            }
        }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readElement(org.w3c.dom.Element elem) throws java.io.IOException {
        /* Drawing Shapes
         ...
         */
        org.jhotdraw.samples.odg.figures.ODGFigure f = null;
        if ((elem.getPrefix() == null) || elem.getPrefix().equals(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE)) {
            ...
            if ("caption".equals(name)) {
                ...
                org.jhotdraw.samples.odg.io.ODGInputFormat.LOG.fine(("ODGInputFormat.readElement(" + elem) + ") not implemented.");
            }
        }
        if (f != null) {
            if (f.isEmpty()) {
                org.jhotdraw.samples.odg.io.ODGInputFormat.LOG.fine("ODGInputFormat.readElement():null - discarded empty figure " + f);
                return null;
            }
        }
        return f;
    ...
    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(org.jhotdraw.samples.odg.io.ODGInputFormat.class.getName());

    private org.jhotdraw.samples.odg.figures.ODGFigure readEllipseElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException("not implemented");
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readCircleElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException("not implemented");
    }
     ...
     * geometry.
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readCustomShapeElement(org.w3c.dom.Element elem) throws java.io.IOException {
        java.lang.String styleName = elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "style-name");
        java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a = styles.getAttributes(styleName, "graphic");
        java.awt.geom.Rectangle2D.Double figureBounds = new java.awt.geom.Rectangle2D.Double(toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "x")).orElse("0"), 1), toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "y")).orElse("0"), 1), toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "width")).orElse("0"), 1), toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "height")).orElse("0"), 1));
        org.jhotdraw.samples.odg.figures.ODGFigure figure = null;
        org.w3c.dom.NodeList list = elem.getElementsByTagNameNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "enhanced-geometry");
        for (int i = 0; i < list.getLength(); i++) {
            org.w3c.dom.Element child = ((org.w3c.dom.Element) (list.item(i)));
    ...
    private org.jhotdraw.samples.odg.figures.ODGFigure readEnhancedGeometryElement(org.w3c.dom.Element elem, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a, java.awt.geom.Rectangle2D.Double figureBounds) throws java.io.IOException {
         ...
         */
        java.lang.String type = java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "type")).orElse("non-primitive");
        java.lang.String pathAttr = java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "enhanced-path")).orElse(null);
        org.jhotdraw.samples.odg.geom.EnhancedPath path = (pathAttr != null) ? toEnhancedPath(pathAttr) : null;
         ...
         */
        java.lang.String[] viewBoxValues = org.jhotdraw.samples.odg.io.ODGInputFormat.toWSOrCommaSeparatedArray(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "viewBox")).orElse("0 0 100 100"));
        java.awt.geom.Rectangle2D.Double viewBox = new java.awt.geom.Rectangle2D.Double(toNumber(viewBoxValues[0]), toNumber(viewBoxValues[1]), toNumber(viewBoxValues[2]), toNumber(viewBoxValues[3]));
        java.awt.geom.AffineTransform viewTx = new java.awt.geom.AffineTransform();
        if (!viewBox.isEmpty()) {
         ...
         */
        boolean mirrorVertical = "true".equals(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "mirror-vertical"));
        boolean mirrorHorizontal = "true".equals(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "mirror-horizontal"));
        ...
        org.jhotdraw.samples.odg.figures.ODGFigure figure;
        if ("rectangle".equals(type)) {
            ...
            java.lang.System.out.println("ODGInputFormat.readEnhancedGeometryElement not implemented for " + elem);
            figure = null;
        }
        return figure;
    }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createEnhancedGeometryEllipseFigure(java.awt.geom.Rectangle2D.Double bounds, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGEllipseFigure figure = new org.jhotdraw.samples.odg.figures.ODGEllipseFigure();
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createEnhancedGeometryRectangleFigure(java.awt.geom.Rectangle2D.Double bounds, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGRectFigure figure = new org.jhotdraw.samples.odg.figures.ODGRectFigure();
        figure.setBounds(bounds);
        figure.attr().setAttributes(a);
        return figure;
    }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createLineFigure(java.awt.geom.Point2D.Double p1, java.awt.geom.Point2D.Double p2, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGPathFigure figure = new org.jhotdraw.samples.odg.figures.ODGPathFigure();
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createPolylineFigure(java.awt.geom.Point2D.Double[] points, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGPathFigure figure = new org.jhotdraw.samples.odg.figures.ODGPathFigure();
        org.jhotdraw.samples.odg.figures.ODGBezierFigure bezier = new org.jhotdraw.samples.odg.figures.ODGBezierFigure();
        for (java.awt.geom.Point2D.Double p : points) {
            bezier.addNode(new org.jhotdraw.geom.path.BezierPath.Node(p.x, p.y));
        }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createPolygonFigure(java.awt.geom.Point2D.Double[] points, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGPathFigure figure = new org.jhotdraw.samples.odg.figures.ODGPathFigure();
        org.jhotdraw.samples.odg.figures.ODGBezierFigure bezier = new org.jhotdraw.samples.odg.figures.ODGBezierFigure();
        for (java.awt.geom.Point2D.Double p : points) {
            bezier.addNode(new org.jhotdraw.geom.path.BezierPath.Node(p.x, p.y));
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure createPathFigure(org.jhotdraw.geom.path.BezierPath[] paths, java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGPathFigure figure = new org.jhotdraw.samples.odg.figures.ODGPathFigure();
        figure.removeAllChildren();
        for (org.jhotdraw.geom.path.BezierPath p : paths) {
            org.jhotdraw.samples.odg.figures.ODGBezierFigure bezier = new org.jhotdraw.samples.odg.figures.ODGBezierFigure();
     ...
     * 		A &lt;frame&gt; element.
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readFrameElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException("not implemented.");
    }
     ...
     */
    private org.jhotdraw.draw.figure.CompositeFigure createGroupFigure() throws java.io.IOException {
        org.jhotdraw.samples.odg.figures.ODGGroupFigure figure = new org.jhotdraw.samples.odg.figures.ODGGroupFigure();
        return figure;
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readGElement(org.w3c.dom.Element elem) throws java.io.IOException {
        org.jhotdraw.draw.figure.CompositeFigure g = createGroupFigure();
        org.w3c.dom.NodeList list = elem.getChildNodes();
        for (int i = 0; i < list.getLength(); i++) {
            org.w3c.dom.Element child = ((org.w3c.dom.Element) (list.item(i)));
         ...
         */
        return ((org.jhotdraw.samples.odg.figures.ODGFigure) (g));
    }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readLineElement(org.w3c.dom.Element elem) throws java.io.IOException {
        java.awt.geom.Point2D.Double p1 = new java.awt.geom.Point2D.Double(toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "x1")).orElse("0"), 1), toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "y1")).orElse("0"), 1));
        java.awt.geom.Point2D.Double p2 = new java.awt.geom.Point2D.Double(toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "x2")).orElse("0"), 1), toLength(java.util.Optional.ofNullable(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "y2")).orElse("0"), 1));
        java.lang.String styleName = elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "style-name");
        java.util.Map<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a = styles.getAttributes(styleName, "graphic");
        org.jhotdraw.samples.odg.figures.ODGFigure f = createLineFigure(p1, p2, a);
        return f;
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readPathElement(org.w3c.dom.Element elem) throws java.io.IOException {
        java.awt.geom.AffineTransform viewBoxTransform = readViewBoxTransform(elem);
        org.jhotdraw.geom.path.BezierPath[] paths = toPath(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "d"));
        for (org.jhotdraw.geom.path.BezierPath p : paths) {
        ...
        org.jhotdraw.samples.odg.figures.ODGFigure f = createPathFigure(paths, a);
        return f;
    }
     ...
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readPolygonElement(org.w3c.dom.Element elem) throws java.io.IOException {
        java.awt.geom.AffineTransform viewBoxTransform = readViewBoxTransform(elem);
        java.lang.String[] coords = org.jhotdraw.samples.odg.io.ODGInputFormat.toWSOrCommaSeparatedArray(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "points"));
        java.awt.geom.Point2D.Double[] points = new java.awt.geom.Point2D.Double[coords.length / 2];
        for (int i = 0; i < coords.length; i += 2) {
            java.awt.geom.Point2D.Double p = new java.awt.geom.Point2D.Double(toNumber(coords[i]), toNumber(coords[i + 1]));
            points[i / 2] = ((java.awt.geom.Point2D.Double) (viewBoxTransform.transform(p, p)));
        }
        java.lang.String styleName = elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "style-name");
        java.util.HashMap<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a = new java.util.HashMap<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object>();
        a.putAll(styles.getAttributes(styleName, "graphic"));
        readCommonDrawingShapeAttributes(elem, a);
        org.jhotdraw.samples.odg.figures.ODGFigure f = createPolygonFigure(points, a);
        return f;
    }
     ...
     * Text – see section 9.2.17.
     */
    private org.jhotdraw.samples.odg.figures.ODGFigure readPolylineElement(org.w3c.dom.Element elem) throws java.io.IOException {
        java.awt.geom.AffineTransform viewBoxTransform = readViewBoxTransform(elem);
        java.lang.String[] coords = org.jhotdraw.samples.odg.io.ODGInputFormat.toWSOrCommaSeparatedArray(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "points"));
        java.awt.geom.Point2D.Double[] points = new java.awt.geom.Point2D.Double[coords.length / 2];
        for (int i = 0; i < coords.length; i += 2) {
        ...
        a.putAll(styles.getAttributes(styleName, "graphic"));
        readCommonDrawingShapeAttributes(elem, a);
        org.jhotdraw.samples.odg.figures.ODGFigure f = createPolylineFigure(points, a);
        return f;
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readRectElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException(("ODGInputFormat.readRectElement(" + elem) + "):null - not implemented");
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readRegularPolygonElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException(("ODGInputFormat.readRegularPolygonElement(" + elem) + "):null - not implemented");
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readMeasureElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException(("ODGInputFormat.readMeasureElement(" + elem) + "):null - not implemented");
    }

    private org.jhotdraw.samples.odg.figures.ODGFigure readCaptionElement(org.w3c.dom.Element elem) throws java.io.IOException {
        throw new java.lang.UnsupportedOperationException(("ODGInputFormat.readCaptureElement(" + elem) + "):null - not implemented");
    }
     ...
     */
    private double toNumber(java.lang.String str) throws java.io.IOException {
     ...
     */
    private double toLength(java.lang.String str, double percentFactor) throws java.io.IOException {
    ...
    private static double toUnitFactor(java.lang.String str) throws java.io.IOException {
        double scaleFactor;
        if ("px".equals(str)) {
            scaleFactor = 1.0;
        } else if (str.endsWith("pt")) {
     ...
     */
    private org.jhotdraw.samples.odg.geom.EnhancedPath toEnhancedPath(java.lang.String str) throws java.io.IOException {
        org.jhotdraw.samples.odg.geom.EnhancedPath path = null;
        java.lang.Object x;
        java.lang.Object y;
        java.lang.Object x1;
        java.lang.Object y1;
        ...
        Commands : while (tt.nextToken() != org.jhotdraw.io.StreamPosTokenizer.TT_EOF) {
            ...
            switch (command) {
                case 'M' :
                    ...
                    if (path == null) {
                        path = new org.jhotdraw.samples.odg.geom.EnhancedPath();
                    }
                ...
                case 'Q' :
                    ...
                    break;
                default :
                    org.jhotdraw.samples.odg.io.ODGInputFormat.LOG.fine((("ODGInputFormat.toEnhancedPath aborting after illegal path command: " + command) + " found in path ") + str);
                    break Commands;
            }
        } 
        return path;
     ...
     */
    private java.lang.Object nextEnhancedCoordinate(org.jhotdraw.io.StreamPosTokenizer tt, java.lang.String str) throws java.io.IOException {
        switch (tt.nextToken()) {
            case '?' :
            ...
            case '$' :
                ...
                tt.pushCharBack(ch);
                return buf.toString();
            case org.jhotdraw.io.StreamPosTokenizer.TT_NUMBER :
                return tt.nval;
            default :
                throw new java.io.IOException((("coordinate missing at position" + tt.getStartPosition()) + " in ") + str);
        }
    }

    private void readCommonDrawingShapeAttributes(org.w3c.dom.Element elem, java.util.HashMap<org.jhotdraw.draw.AttributeKey<?>, java.lang.Object> a) throws java.io.IOException {
        // The attribute draw:name assigns a name to the drawing shape.
        org.jhotdraw.samples.odg.ODGAttributeKeys.NAME.put(a, elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "name"));
        // The draw:transform attribute specifies a list of transformations that
        // can be applied to a drawing shape.
        org.jhotdraw.draw.AttributeKeys.TRANSFORM.put(a, org.jhotdraw.samples.odg.io.ODGInputFormat.toTransform(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.DRAWING_NAMESPACE, "transform")));
    }

    private java.awt.geom.AffineTransform readViewBoxTransform(org.w3c.dom.Element elem) throws java.io.IOException {
        ...
        java.lang.String[] viewBoxValues = org.jhotdraw.samples.odg.io.ODGInputFormat.toWSOrCommaSeparatedArray(elem.getAttributeNS(org.jhotdraw.samples.odg.ODGConstants.SVG_NAMESPACE, "viewBox"));
     ...
     * </ul>
     */
    public static java.awt.geom.AffineTransform toTransform(java.lang.String str) throws java.io.IOException {
        java.awt.geom.AffineTransform t = new java.awt.geom.AffineTransform();
        java.awt.geom.AffineTransform t2 = new java.awt.geom.AffineTransform();
        if (str != null) {
            org.jhotdraw.io.StreamPosTokenizer tt = new org.jhotdraw.io.StreamPosTokenizer(new java.io.StringReader(str));
            tt.resetSyntax();
            tt.wordChars('a', 'z');
            ...
            while (tt.nextToken() != org.jhotdraw.io.StreamPosTokenizer.TT_EOF) {
                ...
                if ("matrix".equals(type)) {
                    ...
                    t.preConcatenate(new java.awt.geom.AffineTransform(m));
                    ...
                    tx = tt.nval;
                    if (tt.nextToken() == org.jhotdraw.io.StreamPosTokenizer.TT_WORD) {
                        tx *= org.jhotdraw.samples.odg.io.ODGInputFormat.toUnitFactor(tt.sval);
                    } else {
                        tt.pushBack();
                    }
                    if (tt.nextToken() == org.jhotdraw.io.StreamPosTokenizer.TT_NUMBER) {
                        ty = tt.nval;
                        if (tt.nextToken() == org.jhotdraw.io.StreamPosTokenizer.TT_WORD) {
                            ty *= org.jhotdraw.samples.odg.io.ODGInputFormat.toUnitFactor(tt.sval);
                        } else {
                            tt.pushBack();
                        }
                    } else {
                    ...
                    angle = tt.nval;
                    t.preConcatenate(new java.awt.geom.AffineTransform(1, 0, java.lang.Math.tan((angle * java.lang.Math.PI) / 180), 1, 0, 0));
                    ...
                    angle = tt.nval;
                    t.preConcatenate(new java.awt.geom.AffineTransform(1, java.lang.Math.tan((angle * java.lang.Math.PI) / 180), 0, 1, 0, 0));
                } else {
                    throw new java.io.IOException((("Unknown transform " + type) + " in ") + str);
                }
                if (tt.nextToken() != ')') {
                    throw new java.io.IOException("')' not found in transform " + str);
                }
     ...
     */
    private org.jhotdraw.geom.path.BezierPath[] toPath(java.lang.String str) throws java.io.IOException {
        ...
        Commands : while (tt.nextToken() != org.jhotdraw.io.StreamPosTokenizer.TT_EOF) {
            ...
            switch (command) {
                ...
                case 'a' :
                    ...
                    break;
                default :
                    org.jhotdraw.samples.odg.io.ODGInputFormat.LOG.fine((("SVGInputFormat.toPath aborting after illegal path command: " + command) + " found in path ") + str);
                    break Commands;
