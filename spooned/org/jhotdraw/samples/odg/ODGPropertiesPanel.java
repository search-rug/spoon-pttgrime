...
public class ODGPropertiesPanel extends javax.swing.JPanel {
    ...
    private org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.Double> opacityFieldHandler;

    private org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.Double> opacitySliderHandler;

    private org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.String> linkFieldHandler;
    ...
    public ODGPropertiesPanel() {
        ...
        opacityFieldHandler = new org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.Double>(org.jhotdraw.samples.svg.SVGAttributeKeys.OPACITY, opacityField, editor);
        opacitySliderHandler = new org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.Double>(org.jhotdraw.samples.svg.SVGAttributeKeys.OPACITY, opacitySlider, editor);
        linkFieldHandler = new org.jhotdraw.draw.event.FigureAttributeEditorHandler<java.lang.String>(org.jhotdraw.samples.svg.SVGAttributeKeys.LINK, linkField, editor);
        // set fonts
        java.awt.Font font = getFont().deriveFont(11.0F);
