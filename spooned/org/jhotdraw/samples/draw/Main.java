...
public class Main {
    public static void main(java.lang.String[] args) {
        ...
        org.jhotdraw.samples.draw.DrawApplicationModel model = new org.jhotdraw.samples.draw.DrawApplicationModel();
        model.setName("JHotDraw Draw");
        model.setVersion(org.jhotdraw.samples.draw.Main.class.getPackage().getImplementationVersion());
