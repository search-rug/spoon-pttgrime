 ...
 */
public class ConvexHullOutlineHandle extends org.jhotdraw.draw.handle.AbstractHandle {
     ...
     * @param owner
     */
    public ConvexHullOutlineHandle(org.jhotdraw.samples.svg.figures.SVGPathFigure owner) {
     ...
     * @param owner
     */
    public ConvexHullOutlineHandle(org.jhotdraw.samples.svg.figures.SVGPathFigure owner, boolean isTransformHandle, boolean isHoverHandle) {
        super(owner);
    ...
    protected java.awt.Rectangle basicGetBounds() {
        java.awt.Shape bounds = getOwner().getBounds();
    ...
    public void draw(java.awt.Graphics2D g) {
        if (outline == null) {
            ...
            bounds = view.getDrawingToViewTransform().createTransformedShape(bounds);
            outline = org.jhotdraw.geom.ConvexHull.getConvexHullPath2D(bounds);
        }
