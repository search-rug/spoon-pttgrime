 ...
 */
public class ToggleLineNumbersAction extends org.jhotdraw.action.AbstractViewAction {
    private static final long serialVersionUID = 1L;

    public static final java.lang.String ID = "view.toggleLineNumbers";
    ...
    public ToggleLineNumbersAction(org.jhotdraw.api.app.Application app, org.jhotdraw.api.app.View view) {
        super(app, view);
        labels.configureAction(this, org.jhotdraw.samples.teddy.action.ToggleLineNumbersAction.ID);
    ...
    protected void updateView() {
        putValue(javax.swing.Action.SELECTED_KEY, (getActiveView() != null) && getActiveView().isLineNumbersVisible());
    }
}