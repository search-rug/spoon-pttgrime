...
public interface URIChooser {
     ...
     */
    public static final int OPEN_DIALOG = javax.swing.JFileChooser.OPEN_DIALOG;

    /**
     * Type value indicating that the {@code URIChooser} supports a "Save" file operation.
     */
    public static final int SAVE_DIALOG = javax.swing.JFileChooser.SAVE_DIALOG;

    /**
     * Type value indicating that the {@code URIChooser} supports a developer-specified file
     * operation.
     */
    public static final int CUSTOM_DIALOG = javax.swing.JFileChooser.CUSTOM_DIALOG;
     ...
     */
    public static final int CANCEL_OPTION = javax.swing.JFileChooser.CANCEL_OPTION;

    /**
     * Return value if approve (yes, ok) is chosen.
     */
    public static final int APPROVE_OPTION = javax.swing.JFileChooser.APPROVE_OPTION;

    /**
     * Return value if an error occured.
     */
    public static final int ERROR_OPTION = javax.swing.JFileChooser.ERROR_OPTION;
     ...
     */
    public static final java.lang.String CANCEL_SELECTION = javax.swing.JFileChooser.CANCEL_SELECTION;

    /**
     * Instruction to approve the current selection (same as pressing yes or ok).
     */
    public static final java.lang.String APPROVE_SELECTION = javax.swing.JFileChooser.APPROVE_SELECTION;

    /**
     * Identifies a change in the selected URI.
     */
    public static final java.lang.String SELECTED_URI_PROPERTY = "selectedURI";

    /**
     * Identifies a change in the dialog title.
     */
    public static final java.lang.String DIALOG_TITLE_PROPERTY = javax.swing.JFileChooser.DIALOG_TITLE_CHANGED_PROPERTY;
     ...
     * user to choose an URI to execute. Note that you normally would not need to set the {@code URIChooser} to use {@code CUSTOM_DIALOG} since a call to {@code setApproveButtonText} does this
     ...
     * 		if {@code dialogType} is not legal
     * @see #getDialogType
     ...
     * 		the text used in the {@code ApproveButton}
     ...
     *
     * @param dialogTitle
     * 		the new {@code String} for the title bar
     * @see #getDialogTitle
     */
     ...
     *
     * @param parent
     * 		the parent component of the dialog, can be {@code null}; see {@code showDialog}
     * 		for details
     ...
     * @param approveButtonText
     * 		the text of the {@code ApproveButton}
     * @return the return state of the file chooser on popdown:
    <ul>
    <li>URIChooser.CANCEL_OPTION
    <li>URIChooser.APPROVE_OPTION
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public int showDialog(java.awt.Component parent, java.lang.String approveButtonText) throws java.awt.HeadlessException;
}