...
public interface ApplicationModel {
     ...
     * 		the view
     */
    public void destroyView(org.jhotdraw.api.app.Application a, org.jhotdraw.api.app.View v);
     ...
     * 		Application.
     * @param v
     * 		The view for which the toolbars need to be created, or null if the actions are to be
     ...
     * 		Application.
     * @param v
     * 		The view for which the toolbars need to be created, or null if the toolbars are shared
     * 		by multiple views.
     * @return the created tool bars
     */
    public java.util.List<javax.swing.JToolBar> createToolBars(org.jhotdraw.api.app.Application a, org.jhotdraw.api.app.View v);
     ...
     * 		Application.
     * @param v
     * 		The view for which the chooser needs to be created, or null if the chooser is shared
     * 		by multiple views.
     ...
     * empty view.
     *
     * <p>This method defines an API for the <em>Open last URI on Launch</em> feature. See {@link org.jhotdraw.api.app}.
     *
     ...
     *
     * <p>This method defines an API for the <em>Allow multiple views for URI</em> feature. See {@link org.jhotdraw.api.app}.
     *
