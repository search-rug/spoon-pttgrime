 ...
 * {@code Application} also provides an API for data suppliers in {@link #addRecentURI}, {@link #getRecentURIs}, {@link #clearRecentURIs}.<br>
 ...
 * {@code MenuBuilder} is used by {@code Application} for creating menu items. The {@code MenuBuilder} is provided by {@code ApplicationModel}.<br>
...
public interface Application {
     ...
     */
    public static final java.lang.String RECENT_URIS_PROPERTY = "recentURIs";
     ...
     * application-specific properties in {@code ResourceBundleUtil}. For example with {@code ResourceBundleUtil.putPropertyNameModifier("os", "mac", "default");}
     */
    public void init();
     ...
     *
     * @param uris
     * 		Upon launch, the application may be requested to open views for a given list of
     * 		URI's.
     */
     ...
     * call {@link #add(View)}. To make it visible, first call {@code add(View)}, then {@link #show(View)}.
     *
     ...
     * 		the view
     */
    public void dispose(org.jhotdraw.api.app.View v);
     ...
     * 		The window.
     * @param view
     * 		The View to which this window is associated, or null if the window is associated to
     * 		the application.
     */
    public void addWindow(java.awt.Window window, org.jhotdraw.api.app.View view);
     ...
     *
     * <p>The most recent URI is used by the <em>Open last URI on launch</em> feature. See {@link org.jhotdraw.api.app}.
     *
     ...
     *
     * <p>The list of views is used by the <em>Allow multiple views per URI</em> feature. See {@link org.jhotdraw.api.app}.
     *
     * @return the views
     */
