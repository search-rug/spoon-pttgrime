...
public class EditGridPanel extends javax.swing.JPanel {
    ...
    private org.jhotdraw.draw.constrainer.GridConstrainer constrainer;
    ...
    public EditGridPanel() {
        ...
        initComponents();
        widthField.setFormatterFactory(org.jhotdraw.formatter.JavaNumberFormatter.createFormatterFactory(0, 1000, 1));
        heightField.setFormatterFactory(org.jhotdraw.formatter.JavaNumberFormatter.createFormatterFactory(0, 1000, 1));
        thetaField.setFormatterFactory(org.jhotdraw.formatter.JavaNumberFormatter.createFormatterFactory(0, 180, 1));
        constrainer = new org.jhotdraw.draw.constrainer.GridConstrainer(10, 10);
        ...
        thetaField.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            @java.lang.Override
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                if ("value".equals(evt.getPropertyName())) {
                    if (evt.getNewValue() != null) {
                        constrainer.setTheta((((java.lang.Double) (evt.getNewValue())) * java.lang.Math.PI) / 180.0);
                    }
                }
            }
        });
     ...
     * 		The GridConstrainer.
     */
    public void setConstrainer(org.jhotdraw.draw.constrainer.GridConstrainer newValue) {
        constrainer = newValue;
        widthField.setValue(constrainer.getWidth());
        heightField.setValue(constrainer.getHeight());
        thetaField.setValue((constrainer.getTheta() * 180.0) / java.lang.Math.PI);
    }
     ...
     */
    public org.jhotdraw.draw.constrainer.GridConstrainer getConstrainer() {
        return constrainer;
    }
