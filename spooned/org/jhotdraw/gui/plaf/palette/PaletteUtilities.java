/**
 *
 * @(#)PaletteUtilities.java <p>Copyright (c) 2008 The authors and contributors of JHotDraw. You may not use, copy or modify
 ...
 * PaletteUtilities.
 */
public class PaletteUtilities extends javax.swing.plaf.basic.BasicGraphicsUtils {
    public static final java.lang.Object beginGraphics(java.awt.Graphics2D graphics2d) {
        java.lang.Object object = graphics2d.getRenderingHint(java.awt.RenderingHints.KEY_TEXT_ANTIALIASING);
    ...
    public static final void endGraphics(java.awt.Graphics2D graphics2d, java.lang.Object oldHints) {
         ...
         */
        if (oldHints != null) {
            graphics2d.setRenderingHint(java.awt.RenderingHints.KEY_TEXT_ANTIALIASING, oldHints);
        }
    }

    /**
     * Draw a string with the graphics {@code g} at location ({@code x}, {@code y}) just like {@code g.drawString} would. The character at index {@code underlinedIndex} in text will be underlined.
    ...
    public static java.awt.FontMetrics getFontMetrics(javax.swing.JComponent c, java.awt.Graphics g) {
        return org.jhotdraw.gui.plaf.palette.PaletteUtilities.getFontMetrics(c, g, g.getFont());
    }
    ...
    public static java.awt.FontMetrics getFontMetrics(javax.swing.JComponent c, java.awt.Graphics g, java.awt.Font font) {
        if (c != null) {
