...
public class ColorIcon implements javax.swing.Icon {
    ...
    public ColorIcon(java.awt.Color color) {
        this(color, color == null ? org.jhotdraw.util.ResourceBundleUtil.getBundle("org.jhotdraw.gui.Labels").getToolTipTextProperty("ColorChooser.colorSwatch.noColor") : (((color.getRed() + ",") + color.getGreen()) + ",") + color.getBlue(), 14, 14);
    }
    ...
    public ColorIcon(java.awt.Color color, java.lang.String name, int width, int height) {
        ...
        this.width = width;
        this.height = height;
        if (org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.noColorImage == null) {
            org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.noColorImage = org.jhotdraw.util.Images.toBufferedImage(org.jhotdraw.util.Images.createImage(org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.class, "/org/jhotdraw/draw/action/images/attribute.color.noColor.png"));
        }
    }
    ...
    public void paintIcon(java.awt.Component c, java.awt.Graphics g, int x, int y) {
        ...
        if ((fillColor == null) || (fillColor.getAlpha() == 0)) {
            if ((width == org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.noColorImage.getWidth()) && (height == org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.noColorImage.getHeight())) {
                g.drawImage(org.jhotdraw.gui.plaf.palette.colorchooser.ColorIcon.noColorImage, x, y, c);
            } else {
