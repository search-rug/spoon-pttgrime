...
public class PaletteColorChooserMainPanel extends javax.swing.JPanel {
     ...
     */
    private static java.lang.String lastSelectedChooserName = null;
    ...
    public PaletteColorChooserMainPanel() {
        initComponents();
        setOpaque(false);
        tabbedPane.setTabLayoutPolicy(javax.swing.JTabbedPane.WRAP_TAB_LAYOUT);
        tabbedPane.setUI(((javax.swing.plaf.TabbedPaneUI) (org.jhotdraw.gui.plaf.palette.PaletteTabbedPaneUI.createUI(tabbedPane))));
        tabbedPane.putClientProperty("Palette.TabbedPane.paintContentBorder", false);
    }

    public void setPreviewPanel(javax.swing.JComponent c) {
        // there is no preview panel
    }

    public void addColorChooserPanel(final javax.swing.colorchooser.AbstractColorChooserPanel ccp) {
        final java.lang.String displayName = ccp.getDisplayName();
        if (displayName == null) {
            // Return if we haven't initialized yet
            return;
        }
        javax.swing.JPanel centerView = new javax.swing.JPanel(new java.awt.BorderLayout());
        centerView.add(ccp);
