 ...
 */
public class VerticalGridLayout implements java.awt.LayoutManager , java.io.Serializable {
     ...
     * 		if the value of both <code>rows</code> and <code>cols
     * 		</code> is set to zero
     */
    public VerticalGridLayout(int rows, int cols, int hgap, int vgap, boolean isVertical) {
        if ((rows == 0) && (cols == 0)) {
            throw new java.lang.IllegalArgumentException("rows and cols cannot both be zero");
        }
        this.rows = rows;
        this.cols = cols;
        this.hgap = hgap;
    ...
    public java.awt.Dimension preferredLayoutSize(java.awt.Container parent) {
        synchronized(parent.getTreeLock()) {
            ...
            return new java.awt.Dimension(((insets.left + insets.right) + (ncols * w)) + ((ncols - 1) * hgap), ((insets.top + insets.bottom) + (nrows * h)) + ((nrows - 1) * vgap));
        }
    }
