 ...
 * @see ColorSliderUI
 */
public class ColorTrackImageProducer extends java.awt.image.MemoryImageSource {
    private int[] pixels;
    ...
    private org.jhotdraw.color.ColorSliderModel colorizer = new org.jhotdraw.color.DefaultColorSliderModel(java.awt.color.ColorSpace.getInstance(java.awt.color.ColorSpace.CS_sRGB));
    ...
    public ColorTrackImageProducer(int w, int h, int trackBuffer, boolean isHorizontal) {
        ...
        // Green
        // Blue
        new java.awt.image.DirectColorModel(24, 0xff0000, 0xff00, 0xff), 0, w);
        setAnimated(true);
    }
    ...
    private void generateHorizontalColorTrack() {
        ...
        java.awt.color.ColorSpace cs = colorizer.getColorSpace();
        ...
        for (int x = 0, n = (w - trackBuffer) - 1; x <= n; x++) {
            ...
            pixels[x + offset] = org.jhotdraw.color.ColorUtil.CStoRGB24(cs, components, rgb);
        }
        ...
        for (int y = w, n = w * h; y < n; y += w) {
            java.lang.System.arraycopy(pixels, 0, pixels, y, w);
        }
    }
    ...
    private void generateVerticalColorTrack() {
        ...
        for (int y = 0, n = (h - trackBuffer) - 1; y <= n; y++) {
            ...
            pixels[(y + offset) * w] = org.jhotdraw.color.ColorUtil.CStoRGB24(cs, components, rgb);
        }
    ...
    public void setColorSliderModel(org.jhotdraw.color.ColorSliderModel colorizer) {
