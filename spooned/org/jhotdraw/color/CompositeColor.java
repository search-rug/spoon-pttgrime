 ...
 */
public class CompositeColor extends java.awt.Color {
     ...
     *
     * @serial  * @see #getRGBColorComponents
     ...
     * @param components
     * 		an arbitrary number of color components that is compatible with the <code>
     * 		ColorSpace</code>
     * @param alpha
     * 		alpha value
    ...
    public CompositeColor(java.awt.color.ColorSpace cspace, float[] components, float alpha) {
        super((((int) (alpha * 255)) << 24) | org.jhotdraw.color.ColorUtil.toRGB24(cspace, components), true);
        boolean rangeError = false;
        java.lang.StringBuilder badComponentString = new java.lang.StringBuilder();
     ...
     *
     * @param compArray
     * 		an array that this method fills with the color and alpha components of this
     ...
     *
     * @param compArray
     * 		an array that this method fills with the color components of this <code>Color
