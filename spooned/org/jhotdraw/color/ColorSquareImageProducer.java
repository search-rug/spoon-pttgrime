...
/**
 * Produces a square image for {@link JColorWheel} by interpreting two components of a {@code ColorSpace} as x and y coordinates.
 *
 * @see JColorWheel
 * @author Werner Randelshofer
 * @version $Id: ColorWheelImageProducer.java 527 2009-06-07 14:28:19Z rawcoder $
 */
public class ColorSquareImageProducer extends org.jhotdraw.color.AbstractColorWheelImageProducer {
    /**
    ...
    protected void generateLookupTables() {
        ...
        for (int x = 0; x < side; x++) {
            float xRatio = (flipX) ? 1.0F - (x / extentX) : x / extentX;
            for (int y = 0; y < side; y++) {
                float yRatio = (flipY) ? 1.0F - (y / extentY) : y / extentY;
    ...
    public java.awt.Point getColorLocation(float[] components) {
        ...
        java.awt.Point p = new java.awt.Point(((int) (side * radial)) + xOffset, ((int) (side * angular)) + yOffset);
        return p;
    }
