...
public final class Geom {
    ...
    public static boolean lineContainsPoint(int x1, int y1, int x2, int y2, int px, int py) {
        return org.jhotdraw.geom.Geom.lineContainsPoint(x1, y1, x2, y2, px, py, 3.0);
    }
    ...
    public static boolean lineContainsPoint(int x1, int y1, int x2, int y2, int px, int py, double tolerance) {
        ...
        r.add(x2, y2);
        r.grow(java.lang.Math.max(2, ((int) (java.lang.Math.ceil(tolerance)))), java.lang.Math.max(2, ((int) (java.lang.Math.ceil(tolerance)))));
        if (!r.contains(px, py)) {
            return false;
        }
        double a;
        ...
        double y;
        if (x1 == x2) {
            return java.lang.Math.abs(px - x1) <= tolerance;
        }
        if (y1 == y2) {
            return java.lang.Math.abs(py - y1) <= tolerance;
        }
        a = ((double) (y1 - y2)) / ((double) (x1 - x2));
        b = ((double) (y1)) - (a * ((double) (x1)));
        x = (py - b) / a;
        y = (a * px) + b;
        return java.lang.Math.min(java.lang.Math.abs(x - px), java.lang.Math.abs(y - py)) <= tolerance;
    }
    ...
    public static boolean lineContainsPoint(double x1, double y1, double x2, double y2, double px, double py, double tolerance) {
        java.awt.geom.Rectangle2D.Double r = new java.awt.geom.Rectangle2D.Double(x1, y1, 0, 0);
        r.add(x2, y2);
        double grow = java.lang.Math.max(2, ((int) (java.lang.Math.ceil(tolerance))));
        r.x -= grow;
        r.y -= grow;
        r.width += grow * 2;
        r.height += grow * 2;
     ...
     */
    public static final int OUT_TOP = java.awt.geom.Rectangle2D.OUT_TOP;

    /**
     * The bitmask that indicates that a point lies below the rectangle.
     */
    public static final int OUT_BOTTOM = java.awt.geom.Rectangle2D.OUT_BOTTOM;

    /**
     * The bitmask that indicates that a point lies to the left of the rectangle.
     */
    public static final int OUT_LEFT = java.awt.geom.Rectangle2D.OUT_LEFT;

    /**
     * The bitmask that indicates that a point lies to the right of the rectangle.
     */
    public static final int OUT_RIGHT = java.awt.geom.Rectangle2D.OUT_RIGHT;
    ...
    public static int direction(int x1, int y1, int x2, int y2) {
        ...
        int vy = y2 - y1;
        if ((vy < vx) && (vx > (-vy))) {
            direction = org.jhotdraw.geom.Geom.OUT_RIGHT;
        } else if ((vy > vx) && (vy > (-vx))) {
            direction = org.jhotdraw.geom.Geom.OUT_TOP;
        } else if ((vx < vy) && (vx < (-vy))) {
            direction = org.jhotdraw.geom.Geom.OUT_LEFT;
        } else {
            direction = org.jhotdraw.geom.Geom.OUT_BOTTOM;
        }
        return direction;
    }
    ...
    public static int outcode(java.awt.Rectangle r1, java.awt.Rectangle r2) {
        ...
        if (r2.x > (r1.x + r1.width)) {
            outcode = org.jhotdraw.geom.Geom.OUT_RIGHT;
        } else if ((r2.x + r2.width) < r1.x) {
            outcode = org.jhotdraw.geom.Geom.OUT_LEFT;
        }
        if (r2.y > (r1.y + r1.height)) {
            outcode |= org.jhotdraw.geom.Geom.OUT_BOTTOM;
        } else if ((r2.y + r2.height) < r1.y) {
            outcode |= org.jhotdraw.geom.Geom.OUT_TOP;
        }
        return outcode;
    }
    ...
    public static java.awt.geom.Point2D.Double center(java.awt.geom.Rectangle2D.Double r) {
        return new java.awt.geom.Point2D.Double(r.x + (r.width / 2), r.y + (r.height / 2));
    }
    ...
    public static java.awt.geom.Point2D.Double chop(java.awt.Shape shape, java.awt.geom.Point2D.Double p) {
        ...
        double cx = -1;
        double cy = -1;
        double len = java.lang.Double.MAX_VALUE;
        // Try for points along edge
        java.awt.geom.PathIterator i = shape.getPathIterator(new java.awt.geom.AffineTransform(), 1);
        ...
        for (; !i.isDone(); i.next()) {
            ...
            java.awt.geom.Point2D.Double chop = org.jhotdraw.geom.Geom.intersect(prevX, prevY, coords[0], coords[1], p.x, p.y, ctr.x, ctr.y);
            if (chop != null) {
                double cl = org.jhotdraw.geom.Geom.length2(chop.x, chop.y, p.x, p.y);
                if (cl < len) {
                    len = cl;
                    cx = chop.x;
                    cy = chop.y;
        ...
        if (len == java.lang.Double.MAX_VALUE) {
            i = shape.getPathIterator(new java.awt.geom.AffineTransform(), 1);
            for (; !i.isDone(); i.next()) {
                i.currentSegment(coords);
                double l = org.jhotdraw.geom.Geom.length2(ctr.x, ctr.y, coords[0], coords[1]);
                if (l < len) {
                    len = l;
                    cx = coords[0];
                    cy = coords[1];
    ...
    public static double length(double x1, double y1, double x2, double y2) {
        return java.lang.Math.sqrt(org.jhotdraw.geom.Geom.length2(x1, y1, x2, y2));
    }
    ...
    public static double length(java.awt.geom.Point2D.Double p1, java.awt.geom.Point2D.Double p2) {
        return java.lang.Math.sqrt(org.jhotdraw.geom.Geom.length2(p1.x, p1.y, p2.x, p2.y));
    }
    ...
    public static java.awt.geom.Point2D.Double cap(java.awt.geom.Point2D.Double p1, java.awt.geom.Point2D.Double p2, double radius) {
        double angle = (java.lang.Math.PI / 2) - java.lang.Math.atan2(p2.x - p1.x, p2.y - p1.y);
        java.awt.geom.Point2D.Double p3 = new java.awt.geom.Point2D.Double(p2.x + (radius * java.lang.Math.cos(angle)), p2.y + (radius * java.lang.Math.sin(angle)));
        return p3;
    }
    ...
    public static double angle(double x1, double y1, double x2, double y2) {
        return java.lang.Math.atan2(y2 - y1, x2 - x1);
    }
    ...
    public static java.awt.Point angleToPoint(java.awt.Rectangle r, double angle) {
        ...
        if (java.lang.Math.abs(si) > e) {
            ...
            x = org.jhotdraw.geom.Geom.range(0, r.width, x);
        } else if (co >= 0.0) {
            x = r.width;
        }
        if (java.lang.Math.abs(co) > e) {
            y = ((int) (((1.0 + (si / java.lang.Math.abs(co))) / 2.0) * r.height));
            y = org.jhotdraw.geom.Geom.range(0, r.height, y);
        } else if (si >= 0.0) {
            y = r.height;
        }
    ...
    public static java.awt.geom.Point2D.Double angleToPoint(java.awt.geom.Rectangle2D.Double r, double angle) {
        ...
        double y = 0;
        if (java.lang.Math.abs(si) > e) {
            x = ((1.0 + (co / java.lang.Math.abs(si))) / 2.0) * r.width;
            x = org.jhotdraw.geom.Geom.range(0, r.width, x);
        } else if (co >= 0.0) {
            x = r.width;
        }
        if (java.lang.Math.abs(co) > e) {
            y = ((1.0 + (si / java.lang.Math.abs(co))) / 2.0) * r.height;
            y = org.jhotdraw.geom.Geom.range(0, r.height, y);
        } else if (si >= 0.0) {
            y = r.height;
        }
    ...
    public static java.awt.geom.Point2D.Double polarToPoint2D(double angle, double fx, double fy) {
        double si = java.lang.Math.sin(angle);
        double co = java.lang.Math.cos(angle);
        return new java.awt.geom.Point2D.Double((fx * co) + 0.5, (fy * si) + 0.5);
    }
    ...
    public static java.awt.Point ovalAngleToPoint(java.awt.Rectangle r, double angle) {
        java.awt.Point center = org.jhotdraw.geom.Geom.center(r);
        java.awt.Point p = org.jhotdraw.geom.Geom.polarToPoint(angle, r.width / 2, r.height / 2);
    ...
    public static java.awt.geom.Point2D.Double ovalAngleToPoint(java.awt.geom.Rectangle2D.Double r, double angle) {
        java.awt.geom.Point2D.Double center = org.jhotdraw.geom.Geom.center(r);
        java.awt.geom.Point2D.Double p = org.jhotdraw.geom.Geom.polarToPoint2D(angle, r.width / 2, r.height / 2);
     ...
     */
    // from Doug Lea's PolygonFigure
    public static java.awt.geom.Point2D.Double intersect(double xa, // line 1 point 1 x
    ...
    double yd) {
        ...
        if (denom == 0.0) {
            ...
            if (rnum == 0.0) {
                // coincident; pick one end of first line
                if (((xa < xb) && ((xb < xc) || (xb < xd))) || ((xa > xb) && ((xb > xc) || (xb > xd)))) {
                    return new java.awt.geom.Point2D.Double(xb, yb);
                } else {
                    return new java.awt.geom.Point2D.Double(xa, ya);
                }
            } else {
                return null;
            }
    ...
    double yd, double limit) {
        ...
        if ((((0.0 <= r) && (r <= 1.0)) && (0.0 <= s)) && (s <= 1.0)) {
            ...
            double px = xa + ((xb - xa) * r);
            double py = ya + ((yb - ya) * r);
            if ((((org.jhotdraw.geom.Geom.length(xa, ya, px, py) <= limit) || (org.jhotdraw.geom.Geom.length(xb, yb, px, py) <= limit)) || (org.jhotdraw.geom.Geom.length(xc, yc, px, py) <= limit)) || (org.jhotdraw.geom.Geom.length(xd, yd, px, py) <= limit)) {
                return new java.awt.geom.Point2D.Double(px, py);
            }
            return null;
        }
    ...
    public static double distanceFromLine(int xa, int ya, int xb, int yb, int xc, int yc) {
        ...
        if (l2 == 0) {
            return org.jhotdraw.geom.Geom.length(xa, ya, xc, yc);
        }
     ...
     */
    public static boolean contains(java.awt.geom.Rectangle2D.Double r1, java.awt.geom.Rectangle2D.Double r2) {
        return (((r2.x >= r1.x) && (r2.y >= r1.y)) && ((r2.x + java.lang.Math.max(0, r2.width)) <= (r1.x + java.lang.Math.max(0, r1.width)))) && ((r2.y + java.lang.Math.max(0, r2.height)) <= (r1.y + java.lang.Math.max(0, r1.height)));
    }
     ...
     * @return true if r1 contains r2.
     */
    public static boolean contains(java.awt.geom.Rectangle2D r1, java.awt.geom.Rectangle2D r2) {
        return (((r2.getX() >= r1.getX()) && (r2.getY() >= r1.getY())) && ((r2.getX() + java.lang.Math.max(0, r2.getWidth())) <= (r1.getX() + java.lang.Math.max(0, r1.getWidth())))) && ((r2.getY() + java.lang.Math.max(0, r2.getHeight())) <= (r1.getY() + java.lang.Math.max(0, r1.getHeight())));
    }
}