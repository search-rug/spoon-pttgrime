 ...
 */
public class BezierLabelLocator extends org.jhotdraw.draw.locator.LinearLabelLocator {
    /**
     * For write/read.
     */
    ...
    public org.jhotdraw.draw.locator.Locator.Position locate(org.jhotdraw.draw.figure.Figure owner, double scale) {
        return getRelativePoint((double relative,double tolerance) -> ((org.jhotdraw.draw.figure.BezierFigure) (owner)).getPointOnPath(relative, 3), scale);
    }
    ...
    public org.jhotdraw.draw.locator.Locator.Position locate(org.jhotdraw.draw.figure.Figure owner, org.jhotdraw.draw.figure.Figure label, double scale) {
        return getRelativeLabelPoint((double relative,double tolerance) -> ((org.jhotdraw.draw.figure.BezierFigure) (owner)).getPointOnPath(relative, 3), label, scale);
    }
}