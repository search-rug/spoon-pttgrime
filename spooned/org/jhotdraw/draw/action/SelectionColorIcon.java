...
public class SelectionColorIcon extends javax.swing.ImageIcon {
     ...
     */
    public SelectionColorIcon(org.jhotdraw.draw.DrawingEditor editor, org.jhotdraw.draw.AttributeKey<java.awt.Color> key, java.net.URL imageLocation, java.awt.Shape colorShape) {
        super(imageLocation);
        this.editor = editor;
        this.key = key;
    ...
    public SelectionColorIcon(org.jhotdraw.draw.DrawingEditor editor, org.jhotdraw.draw.AttributeKey<java.awt.Color> key, java.awt.Image image, java.awt.Shape colorShape) {
        super(image);
        this.editor = editor;
        this.key = key;
        this.colorShape = colorShape;
