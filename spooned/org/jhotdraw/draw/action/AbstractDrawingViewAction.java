 ...
 *
 * <p>By default the enabled state of this action reflects the enabled state of the {@code DrawingView}. If no drawing view is active, this action is disabled. When many actions listen to
 ...
 * listens for property changes in the {@code DrawingEditor}. It listens using a {@link WeakPropertyChangeListener} on the {@code DrawingEditor} and thus may become garbage collected if
 * it is not referenced by any other object.
 */
public abstract class AbstractDrawingViewAction extends javax.swing.AbstractAction implements org.jhotdraw.api.app.Disposable {
    private static final long serialVersionUID = 1L;

    private org.jhotdraw.draw.DrawingEditor editor;

    private org.jhotdraw.draw.DrawingView specificView;

    private transient org.jhotdraw.draw.DrawingView activeView;

    private class EventHandler implements java.beans.PropertyChangeListener {
        @java.lang.Override
        public void propertyChange(java.beans.PropertyChangeEvent evt) {
            if ("enabled".equals(evt.getPropertyName())) {
                updateEnabledState();
            } else if (((evt.getPropertyName() == null) && (org.jhotdraw.draw.DrawingEditor.ACTIVE_VIEW_PROPERTY == null)) || ((evt.getPropertyName() != null) && evt.getPropertyName().equals(org.jhotdraw.draw.DrawingEditor.ACTIVE_VIEW_PROPERTY))) {
                if (activeView != null) {
    ...
    private org.jhotdraw.draw.action.AbstractDrawingViewAction.EventHandler eventHandler = new org.jhotdraw.draw.action.AbstractDrawingViewAction.EventHandler();

    /**
     * Creates a view action which acts on the current view of the editor.
     */
    public AbstractDrawingViewAction(org.jhotdraw.draw.DrawingEditor editor) {
        setEditor(editor);
    }
     ...
     */
    public AbstractDrawingViewAction(org.jhotdraw.draw.DrawingView view) {
        this.specificView = view;
        registerEventHandler();
    }

    protected void setEditor(org.jhotdraw.draw.DrawingEditor newValue) {
    ...
    public void setUpdateEnabledState(boolean newValue) {
        ...
        if ((eventHandler != null) != newValue) {
            if (newValue) {
                eventHandler = new org.jhotdraw.draw.action.AbstractDrawingViewAction.EventHandler();
                registerEventHandler();
            } else {
                unregisterEventHandler();
                eventHandler = null;
