...
public class EditorColorIcon extends javax.swing.ImageIcon {
     ...
     */
    public EditorColorIcon(org.jhotdraw.draw.DrawingEditor editor, org.jhotdraw.draw.AttributeKey<java.awt.Color> key, java.net.URL imageLocation, java.awt.Shape colorShape) {
        super(imageLocation);
        this.editor = editor;
        this.key = key;
    ...
    public EditorColorIcon(org.jhotdraw.draw.DrawingEditor editor, org.jhotdraw.draw.AttributeKey<java.awt.Color> key, java.awt.Image image, java.awt.Shape colorShape) {
        super(image);
        this.editor = editor;
        this.key = key;
        this.colorShape = colorShape;
    ...
    public void paintIcon(java.awt.Component c, java.awt.Graphics gr, int x, int y) {
        ...
        java.awt.Color color = editor.getDefaultAttribute(key);
        if (color != null) {
            g.setColor(color);
            g.translate(x, y);
            g.fill(colorShape);
