 ...
 *
 * <p>By default the enabled state of this action reflects the enabled state of the {@code DrawingEditor}. When many actions listen to the enabled state of the drawing editor this can
 ...
 * object.
 */
public abstract class AbstractDrawingEditorAction extends javax.swing.AbstractAction {
    ...
    private org.jhotdraw.draw.action.AbstractDrawingEditorAction.EventHandler eventHandler = new org.jhotdraw.draw.action.AbstractDrawingEditorAction.EventHandler();

    public AbstractDrawingEditorAction(org.jhotdraw.draw.DrawingEditor editor) {
        setEditor(editor);
    }
    ...
    public void setUpdateEnabledState(boolean newValue) {
        ...
        if ((eventHandler != null) != newValue) {
            if (newValue) {
                eventHandler = new org.jhotdraw.draw.action.AbstractDrawingEditorAction.EventHandler();
                registerEventHandler();
            } else {
                unregisterEventHandler();
                eventHandler = null;
