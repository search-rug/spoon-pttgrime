 ...
 */
public class ImageBevelBorder implements javax.swing.border.Border {
     ...
     * border.
     */
    public ImageBevelBorder(java.awt.Image img, java.awt.Insets borderInsets) {
     ...
     * border.
     */
    public ImageBevelBorder(java.awt.Image img, java.awt.Insets imageInsets, java.awt.Insets borderInsets) {
     ...
     * border.
     */
    public ImageBevelBorder(java.awt.Image img, java.awt.Insets imageInsets, java.awt.Insets borderInsets, boolean fillContentArea) {
        if (img instanceof java.awt.image.BufferedImage) {
            this.image = ((java.awt.image.BufferedImage) (img));
        } else {
            java.awt.Frame f = new java.awt.Frame();
            f.pack();
            java.awt.MediaTracker t = new java.awt.MediaTracker(f);
            t.addImage(img, 0);
            try {
                t.waitForAll();
            ...
            image = new java.awt.image.BufferedImage(img.getWidth(f), img.getHeight(f), java.awt.image.BufferedImage.TYPE_INT_ARGB);
    ...
    public java.awt.Insets getBorderInsets(java.awt.Component c) {
        return ((java.awt.Insets) (borderInsets.clone()));
    }
    ...
    public void paintBorder(java.awt.Component c, java.awt.Graphics gr, int x, int y, int width, int height) {
        ...
        if (width < (left + right)) {
            left = java.lang.Math.min(left, width / 2);// Math.max(0, left + (width - left - right) / 2);

            right = width - left;
        }
        if (height < (top + bottom)) {
            top = java.lang.Math.min(top, height / 2);// Math.max(0, top + (height - top - bottom) / 2);
        ...
        // Draw the edges
        java.awt.image.BufferedImage subImg = null;
        java.awt.TexturePaint paint;
        // North
        if ((top > 0) && ((left + right) < width)) {
            subImg = image.getSubimage(left, 0, (imgWidth - right) - left, top);
            paint = new java.awt.TexturePaint(subImg, new java.awt.Rectangle(x + left, y, (imgWidth - left) - right, top));
            g.setPaint(paint);
        ...
        if ((bottom > 0) && ((left + right) < width)) {
            ...
            paint = new java.awt.TexturePaint(subImg, new java.awt.Rectangle(x + left, (y + height) - bottom, (imgWidth - left) - right, bottom));
            g.setPaint(paint);
        ...
        if ((left > 0) && ((top + bottom) < height)) {
            ...
            paint = new java.awt.TexturePaint(subImg, new java.awt.Rectangle(x, y + top, left, (imgHeight - top) - bottom));
            g.setPaint(paint);
        ...
        if ((right > 0) && ((top + bottom) < height)) {
            ...
            paint = new java.awt.TexturePaint(subImg, new java.awt.Rectangle((x + width) - right, y + top, right, (imgHeight - top) - bottom));
            g.setPaint(paint);
        ...
        if (fillContentArea) {
            ...
            if (((left + right) < width) && ((top + bottom) < height)) {
                ...
                paint = new java.awt.TexturePaint(subImg, new java.awt.Rectangle(x + left, y + top, (imgWidth - right) - left, (imgHeight - top) - bottom));
                g.setPaint(paint);
