 ...
 * figure can only be in one drawing at a time. A drawing can be in one or multiple {@link DrawingView}s.
 *
 ...
 *       drawing.
 *   <li>Drawing can hold a number of {@link org.jhotdraw.draw.io.InputFormat}s and {@link org.jhotdraw.draw.io.OutputFormat}s, allowing to read and write a drawing from/to a stream,
 ...
 * Contract: {@link Drawing}, {@link Figure}, {@link DrawingView}, {@link DrawingEditor}, {@link org.jhotdraw.draw.handle.Handle} and {@link org.jhotdraw.draw.tool.Tool}.
 *
...
public interface Drawing {
    org.jhotdraw.draw.figure.Attributes attr();
     ...
     */
    boolean add(org.jhotdraw.draw.figure.Figure figure);
     ...
     * 		to be added to the drawing
     */
    void add(int index, org.jhotdraw.draw.figure.Figure figure);
     ...
     * 		to be added to the drawing
     */
    void addAll(java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);
     ...
     */
    boolean remove(org.jhotdraw.draw.figure.Figure figure);
     ...
     * @see Figure#removeNotify
     * @param figures
     * 		A collection of figures which are part of the drawing and should be removed
     */
    void removeAll(java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);
     ...
     * 		A collection of figures which are part of the drawing and should be removed
     */
    void basicRemoveAll(java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);
     ...
     */
    void basicAdd(org.jhotdraw.draw.figure.Figure figure);
     ...
     * 		that is part of the drawing and should be removed
     */
    void basicAdd(int index, org.jhotdraw.draw.figure.Figure figure);
     ...
     * 		The insertion index.
     * @param figures
     * 		A collection of figures which are part of the drawing and should be reinserted.
     * @see #basicRemoveAll(Collection)
     */
    void basicAddAll(int index, java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);
     ...
     */
    java.util.List<org.jhotdraw.draw.figure.Figure> findFigures(java.awt.geom.Rectangle2D.Double bounds);

    /**
     * Returns all figures that lie within the specified bounds. The figures are returned in Z-order
     * from back to front.
     */
    java.util.List<org.jhotdraw.draw.figure.Figure> findFiguresWithin(java.awt.geom.Rectangle2D.Double bounds);
     ...
     */
    org.jhotdraw.draw.figure.Figure findFigure(java.awt.geom.Point2D.Double p);
     ...
     * <p>Use {@link #findFigureInside} If you need to descend into children of composite figures.
     */
    org.jhotdraw.draw.figure.Figure findFigure(java.awt.geom.Point2D.Double p, double scaleDenominator);

    /**
     * Finds a top level Figure. Use this call for hit detection that should not descend into the
     * figure's children.
     */
    org.jhotdraw.draw.figure.Figure findFigureExcept(java.awt.geom.Point2D.Double p, org.jhotdraw.draw.figure.Figure ignore);

    /**
     * Finds a top level Figure. Use this call for hit detection that should not descend into the
     * figure's children.
     */
    org.jhotdraw.draw.figure.Figure findFigureExcept(java.awt.geom.Point2D.Double p, java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> ignore);

    /**
     * Finds a top level Figure which is behind the specified Figure.
     */
    org.jhotdraw.draw.figure.Figure findFigureBehind(java.awt.geom.Point2D.Double p, org.jhotdraw.draw.figure.Figure figure);

    /**
     * Finds a top level Figure which is behind the specified Figure.
     */
    org.jhotdraw.draw.figure.Figure findFigureBehind(java.awt.geom.Point2D.Double p, double scaleDenominator, org.jhotdraw.draw.figure.Figure figure);

    /**
     * Finds a top level Figure which is behind the specified Figures.
     */
    org.jhotdraw.draw.figure.Figure findFigureBehind(java.awt.geom.Point2D.Double p, java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);

    /**
     * Returns a list of the figures in Z-Order from front to back.
     */
    java.util.List<org.jhotdraw.draw.figure.Figure> getFiguresFrontToBack();
    ...
    in a figure.
     */
    org.jhotdraw.draw.figure.Figure findFigureInside(java.awt.geom.Point2D.Double p);
     ...
     */
    void sendToBack(org.jhotdraw.draw.figure.Figure figure);
     ...
     * 		that is part of the drawing
     */
    void bringToFront(org.jhotdraw.draw.figure.Figure figure);

    /**
     * Returns a copy of the provided collection which is sorted in z order from back to front.
     */
    java.util.List<org.jhotdraw.draw.figure.Figure> sort(java.util.Collection<? extends org.jhotdraw.draw.figure.Figure> figures);
     ...
     */
    void addInputFormat(org.jhotdraw.draw.io.InputFormat format);

    /**
     * Adds an output format to the drawing.
     */
    void addOutputFormat(org.jhotdraw.draw.io.OutputFormat format);
     ...
     */
    void setInputFormats(java.util.List<org.jhotdraw.draw.io.InputFormat> formats);

    /**
     * Gets input formats for the Drawing in order of preferred formats.
     */
    java.util.List<org.jhotdraw.draw.io.InputFormat> getInputFormats();
     ...
     */
    void setOutputFormats(java.util.List<org.jhotdraw.draw.io.OutputFormat> formats);

    /**
     * Gets output formats for the Drawing in order of preferred formats.
     */
    java.util.List<org.jhotdraw.draw.io.OutputFormat> getOutputFormats();
     ...
     */
    public org.jhotdraw.draw.Drawing clone();
}