...
public interface InputFormat {
     ...
     * 		The drawing.
     */
    public default void read(java.net.URI uri, org.jhotdraw.draw.Drawing drawing) throws java.io.IOException {
     ...
     * 		The drawing.
     * @param replace
     * 		Set this to true, if the contents of the file replaces the contents of the
     ...
     * 		drawing view).
     */
    public default void read(java.net.URI uri, org.jhotdraw.draw.Drawing drawing, boolean replace) throws java.io.IOException {
        read(uri.toURL().openStream(), drawing, replace);
    }

    public default void read(java.io.File file, org.jhotdraw.draw.Drawing drawing) throws java.io.IOException {
        read(file, drawing, true);
    }

    public default void read(java.io.File file, org.jhotdraw.draw.Drawing drawing, boolean replace) throws java.io.IOException {
     ...
     * 		The drawing.
     * @param replace
     * 		Set this to true, if the contents of the stream replaces the contents of the
     ...
     * 		The drawing.
     * @param replace
     * 		Set this to true, if the contents of the transferable replaces the contents of
