 ...
 * Subject: {@link org.jhotdraw.draw.tool.Tool}; Observer: {@link ToolListener}; Event: {@link ToolEvent}; Concrete Observer: {@link org.jhotdraw.draw.DrawingEditor}. <hr>
 */
public interface ToolListener extends java.util.EventListener {
    /**
     * Informs the listener that a tool has starteds interacting with a specific drawing view.
     */
    void toolStarted(org.jhotdraw.draw.event.ToolEvent event);

    /**
     * Informs the listener that a tool has done its interaction. This method can be used to switch
     * back to the default tool.
     */
    void toolDone(org.jhotdraw.draw.event.ToolEvent event);
