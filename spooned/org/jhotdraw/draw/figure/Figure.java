 ...
 *   <li>Figures can have an open ended set of attributes. An attribute is identified by an {@link AttributeKey}.
 ...
 * Contract: {@link org.jhotdraw.draw.figure.Figure}, {@link ConnectionFigure}, {@link org.jhotdraw.draw.connector.Connector}, {@link org.jhotdraw.draw.tool.ConnectionTool}.
 *
 ...
 * Subject: {@link Figure}; Observer: {@link org.jhotdraw.draw.event.FigureListener}; Event: {@link org.jhotdraw.draw.event.FigureEvent}; Concrete Observer: {@link CompositeFigure}, {@link DrawingView}.
 *
 ...
 *
 * <p><em>Strategy</em><br>
 * The location of the start and end points of a connection figure are determined by {@code Connector}s which are owned by the connected figures.<br>
 * Context: {@link Figure}, {@link ConnectionFigure}; Strategy: {@link org.jhotdraw.draw.connector.Connector}.
 *
 * <p><em>Strategy</em><br>
 ...
 */
public interface Figure extends org.jhotdraw.draw.figure.AttributeProvider , java.lang.Cloneable , java.io.Serializable {
    // PROPERTIES
    /**
     * The name of the "connectable" property.
     */
    public static final java.lang.String CONNECTABLE_PROPERTY = "connectable";

    /**
     * The name of the "removable" property.
     */
    public static final java.lang.String REMOVABLE_PROPERTY = "removable";

    /**
     * The name of the "selectable" property.
     */
    public static final java.lang.String SELECTABLE_PROPERTY = "selectable";

    /**
     * The name of the "transformable" property.
     */
    public static final java.lang.String TRANSFORMABLE_PROPERTY = "transformable";
     ...
     *
     * @param detailLevel
     * 		The detail level of the handles. Usually this is 0 for bounding box handles
     ...
     */
    public java.awt.Cursor getCursor(java.awt.geom.Point2D.Double p, double scale);
     ...
     * @param prototype
     * 		The prototype used to create a connection or null if unknown. This allows for
     ...
     */
    public org.jhotdraw.draw.figure.Figure clone();
    ...
    public default void processChange(java.util.function.Consumer<org.jhotdraw.draw.figure.Figure> figureConsumer) {
        willChange();
